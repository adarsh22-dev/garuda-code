...
- **TUI**: Ink-based chat interface with an original text Garuda mark, workspace trust gate, gold/indigo theme, confirmation prompts for mutating tools, active session metadata, navigable slash-command palette, coding skills, live token/context estimates, provider switching, and model discovery
