...
export const codeReviewTool: Tool = {
  ...
  definition: {
    name: "code_review",
    description:
      "Perform a thorough code review: check for bugs, anti-patterns, " +
...
export const systemDesignTool: Tool = {
  requiresConfirmation: false,
  definition: {
    name: "system_design",
    description:
      "Help design a system: analyze requirements, suggest architecture, " +
  ...
  async run(input, ctx) {
    ...
    const scaleConfig: Record<string, { users: string; data: string; latency: string; availability: string }> = {
...
export const algoAnalysisTool: Tool = {
  requiresConfirmation: false,
  definition: {
    name: "algo_analysis",
    description:
      "Analyze code for algorithmic complexity (Big O), suggest optimal approaches, " +
...
export const interviewPrepTool: Tool = {
  ...
  definition: {
    name: "interview_prep",
    description:
      "Generate interview prep materials: common questions, STAR stories, " +
