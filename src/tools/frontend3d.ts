...
export const threejsAuditTool: Tool = {
  requiresConfirmation: false,
  definition: {
    name: "threejs_audit",
    description:
      "Audit a Three.js / React Three Fiber project for performance issues: " +
  ...
  async run(input, ctx) {
    ...
    const lines: string[] = ["=== Three.js / R3F Project Audit ===\n"];
...
export const shaderAuditTool: Tool = {
  requiresConfirmation: false,
  definition: {
    name: "shader_audit",
    description:
      "Analyze GLSL shader code for performance issues: " +
  ...
  async run(input, ctx) {
    ...
    const lines: string[] = ["=== Shader Audit ===\n"];
...
export const reactAuditTool: Tool = {
  requiresConfirmation: false,
  definition: {
    name: "react_audit",
    description:
      "Audit React / Next.js code for anti-patterns: " +
  ...
  async run(input, ctx) {
    ...
    const lines: string[] = ["=== React / Next.js Audit ===\n"];
...
export const fastapiAuditTool: Tool = {
  requiresConfirmation: false,
  definition: {
    name: "fastapi_audit",
    description:
      "Audit a FastAPI / Python project for issues: " +
  ...
  async run(input, ctx) {
    ...
    const lines: string[] = ["=== FastAPI / Python Audit ===\n"];
...
export const perfBudgetTool: Tool = {
  requiresConfirmation: false,
  definition: {
    name: "perf_budget",
    description:
      "Analyze bundle size and performance budget: " +
  ...
  async run(input, ctx) {
    ...
    const lines: string[] = ["=== Performance Budget ===\n"];
...
export const a11yAuditTool: Tool = {
  requiresConfirmation: false,
  definition: {
    name: "a11y_audit",
    description:
